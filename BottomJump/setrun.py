...
#------------------------------
    ...
    #clawdata.num_aux = 7
    clawdata.num_aux = 2   # bathy, and pressure
    ...
    #amrdata.aux_type = ['center','capacity','center','center','center','center','center']
    ...
    gaugeno = 0
    #for r in np.linspace(86., 93., 9):   cant do this on reduced domain size omitting poles
    #for r in np.linspace(82., 86., 9):
    # gauges parallel to x-axis:
    #for r in np.linspace(0.0, 49000., 10):
    #    gaugeno = gaugeno+1
    #    x = r + .001  # shift a bit away from cell corners
    #    y = .001
    #    rundata.gaugedata.gauges.append([gaugeno, x, y, 0., 1e10])
    rundata.gaugedata.gauges.append([1, -24000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([2, -19000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([3, -14000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([4,  -9000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([5,  -4000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([6,   1000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([7,   6000.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([8,  11000.001, .001, 0., 1e10])
...
#-------------------
    ...
    #geo_data.coordinate_system = 2   # this is lat-long
    geo_data.coordinate_system = 1  # this is cartesian
    ...
    topo_data.topofiles.append([1, 1, 1, 0., 1.e10, 'flat1.topotype1'])
    topo_data.topofiles.append([1, 1, 1, 0., 1.e10, 'flat2.topotype1'])
    #topo_data.topo_left = -4000.
    #topo_data.topo_right = -4000.
