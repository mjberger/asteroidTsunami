...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        #clawdata.tfinal = 100.85851  # seconds
        clawdata.tfinal = 14000.  # seconds
        #clawdata.tfinal = 15000.  # seconds

        # Output occurrence per day, 24 = every hour, 4 = every 6 hours
        recurrence = 140  # 60 outputs in 6000 sec is every 100 sec 
        clawdata.num_output_times = int((clawdata.tfinal - clawdata.t0) 
                                            / recurrence)

        #clawdata.output_t0 = True   # output at initial (or restart) time?
        clawdata.output_t0 = False  # usually false on restart            
    ...
    #clawdata.cfl_max = 1.
    #clawdata.cfl_desired = 0.2   # initial cfl while pressure pulse is there
    #clawdata.cfl_max =  .4       # in the code it will be upped to .9 after 300 seconds
   ...
   # ---------------
    ...
    # for SouthChinaSea
    gauges.append([1,  115.2 , 13.33,    0, 1e10])  # by blast center (on sensor, same long, almost 2 deg lat diff) 
    ...
    gauges.append([5,  114.52, 20.08,   0, 1e10])  # further from Hong Kong 
    ...
    gauges.append([10,  114.29,  6.32,   0, 1e10])  # Singapore in deep water
    ...
    if clawdata.checkpt_style == 0:
        ...
        clawdata.checkpt_times = [100.85851]
    ...
    amrdata.refinement_ratios_x = [10,4,16]
    amrdata.refinement_ratios_y = [10,4,16]
    amrdata.refinement_ratios_t = [10,4,16]
    ...
    regions.append([2,2,0,100,115.16,115.36,13.23,13.43])
    regions.append([1,2,0,clawdata.tfinal,90.0,135.,-1.,25.0])
    regions.append([3,3,3250,clawdata.tfinal,90.0,135.,-1.,25.0]) # looks like this is first hit on any shelf)
...
#-------------------
    ...
    #                                   '../bathy/GEBCO2014_104.425_4.675_122.425_23.925_30Sec_ESRIASCII.asc'])
