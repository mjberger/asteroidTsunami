...
#------------------------------
    ...
    clawdata.restart_file = 'fort.chk00904'  # File to use for restart data
   ...
   # ---------------
    ...
    gauges.append([1,  -74.00, 40.70,    0, 1e10])  # tip of manhattan
    ...
    regions.append([1,7,clawdata.t0,clawdata.tfinal,-100.,-69.0,37.0,100.])
