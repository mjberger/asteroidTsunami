...
!     aux(pressure_index, i , j) = Pressure Field
    ...
    xc = 0.d0  ! we know that zero is center of domain
    yc = 0.d0
    rsq = 4.5d0*2
    ...
    do j=1-mbc,my+mbc
        ...
        do i=1-mbc,mx+mbc
            ...
            if (abs((x-xc)**2+(y-yc)**2) .lt. rsq) then
                aux(pressure_index,i,j) = 10*ambient_pressure ! Pressure field
            endif
