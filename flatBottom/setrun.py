...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_step_interval = 30000
    ...
    rundata.gaugedata.gauges.append([1, .001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([2, 300.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([3, 600.001, .001, 0., 1e10])
    rundata.gaugedata.gauges.append([4, 1200.001, .001, 0., 1e10])
