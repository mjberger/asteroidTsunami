subroutine src2(meqn,mbc,mx,my,xlower,ylower,dx,dy,q,maux,aux,t,dt,veldif,vxmax,vymax)
    ...
    double precision, intent(inout) :: veldif,vxmax,vymax
            ...
            do i=1,mx  
                ...
                if (h > dry_tolerance) then
                    ...
                    if (abs(velnew-velold) .gt. veldif) then
                       ...
                       vxmax = xlower + (i-.5d0)*dx
                       vymax = ylower + (j-.5d0)*dy
                    endif
                end if
            enddo
        enddo
