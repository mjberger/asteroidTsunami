...
c
     ...
     .    write(*,*)"ERROR in output of Gauge Data "
        ...
        if (xoff < 0.-epsilon .or. xoff > 1.+epsilon  .or. 
     .      yoff < 0.-epsilon .or. yoff > 1.+epsilon) then
...
c velocities are zeroed out which can then lead to increase in h again.
     ...
     &                        * aux(7,iindex,jindex) 
     &                 + xoff * (1.d0 - yoff) * aux(7,iindex+1,jindex) 
     &                 + (1.d0 - xoff) * yoff * aux(7,iindex,jindex+1) 
     &                 + xoff * yoff * aux(7,iindex+1,jindex+1)
              endif
