...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.total_steps = 5000/1   # final time 6000 sec / dtinit of 2 sec
        clawdata.output_t0 = True  # output at initial (or restart) time?
    ...
    #gauges.append([1,  1.01, 40.01, 0, 1e10])
...
if __name__ == '__main__':
    ...
    if not os.path.exists('ocean.topotype2') or \
       not os.path.exists('island.topotype2'):
        import maketopo
        maketopo.maketopo()
